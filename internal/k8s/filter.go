...
// NewNamespaceFilter returns a cache.ResourceEventHandler that
// filters out objects whose namespaces are not included in the
// given slice of namespaces. Objects with matching namespaces
